...
public class Configuration
{
	...
	public ExchangeRatesProvider.ExchangeRate getCachedExchangeRate()
	{
		if (prefs.contains(PREFS_KEY_CACHED_EXCHANGE_CURRENCY) && prefs.contains(PREFS_KEY_CACHED_EXCHANGE_RATE))
		{
			...
			return new ExchangeRatesProvider.ExchangeRate(cachedExchangeCurrency, cachedExchangeRate, null);
		}
		else
		{
			return null;
	...
	public void setCachedExchangeRate(final ExchangeRatesProvider.ExchangeRate cachedExchangeRate)
	{
